...
global.gurl = 'Faisal-md.db' // add your username
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'Faisal-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'faisal' : process.env.OWNER_NAME,
